...
public class ScheduleHistoryListView extends GenericListView<Schedule, ScheduleHistoryPresenter> {
    ...
    private ScheduleHistoryPresenter presenter;
    @Autowired
    ...
    public void setPresenter(final ScheduleHistoryPresenter scheduleHistoryPresenter) {
        this.presenter = scheduleHistoryPresenter;
    }

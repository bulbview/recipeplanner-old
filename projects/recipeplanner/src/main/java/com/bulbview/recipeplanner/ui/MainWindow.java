...
public class MainWindow extends CustomComponent {
    ...
    public VerticalLayout getCategoriesLayout() {
    ...
    private HorizontalLayout buildRecipeAndSchedulerHorizontalLayout() {
        ...
        categoriesLayout.setImmediate(false);
        categoriesLayout.setWidth("300px");
        categoriesLayout.setHeight("500px");
        categoriesLayout.setMargin(false);
        RecipeAndSchedulerHorizontalLayout.addComponent(categoriesLayout);

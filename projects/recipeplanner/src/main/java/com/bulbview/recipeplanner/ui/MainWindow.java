...
public class MainWindow extends CustomComponent {
    ...
    private VerticalLayout buildSchedulerVerticalLayout() {
        ...
        schedulerVerticalLayout.addComponent(popupDateField_1);
        schedulerVerticalLayout.setComponentAlignment(popupDateField_1, new Alignment(20));

        // verticalLayout_4
        verticalLayout_4 = new VerticalLayout();
        verticalLayout_4.setWidth("100.0%");
        verticalLayout_4.setHeight("10px");
        verticalLayout_4.setImmediate(false);
        verticalLayout_4.setMargin(false);
        schedulerVerticalLayout.addComponent(verticalLayout_4);

        // schedulerAccordion
        schedulerAccordion = new Accordion();
        schedulerAccordion.setWidth("300px");
        schedulerAccordion.setHeight("450px");
